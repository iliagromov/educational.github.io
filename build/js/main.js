...
function animations(){
    ...
    animation('.header');
    animation('.banner');
    animation('.service', '.page__title-h2');
    animation('.about', '.page__title-h2');
    animation('.feature', '.page__title-h2');
    animation('.register', '.page__title-h2');
    animation('.team', '.team-block');
    animation('.testimonial', '.testimonial-block');
    animation('.info', '.page__title-h2');
}
